...
fn test_decode_dictionary_string() {
    ...
    dictionary.insert("cow".into(), Bencode::String(b"moo".to_vec()));
    dictionary.insert("spam".into(), Bencode::String(b"eggs".to_vec()));
...
fn test_decode_dictionary_integer() {
    let mut dictionary = BTreeMap::new();
    dictionary.insert("eggs".into(), Bencode::Integer(10));
...
fn test_decode_dictionary_list() {
    ...
    dictionary.insert("spam".into(), Bencode::List(list));
